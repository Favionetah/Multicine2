...
class SalaRepository {
    ...
    public function guardar(array $datos): bool {
        $capacidad = (int)$datos['filas'] * (int)$datos['columnas'];
        ...
        $sql = "INSERT INTO salas (nombre, capacidad, filas, columnas, precio, imagen, tipo) 
                VALUES (:nombre, :capacidad, :filas, :columnas, :precio, :imagen, :tipo)";
        $stmt = $this->db->prepare($sql);
        return $stmt->execute([
            ':nombre' => $datos['nombre'], ':capacidad' => $capacidad,
            ':filas' => $datos['filas'], ':columnas' => $datos['columnas'],
            ':precio' => $datos['precio'], ':imagen' => $imagen, ':tipo' => $tipo
        ]);
    }
    ...
    public function editar(array $datos): bool {
        ...
        $sql = "UPDATE salas SET nombre = :nombre, capacidad = :capacidad, 
        ...
        return $stmt->execute([
            ':nombre' => $datos['nombre'], ':capacidad' => $capacidad,
            ':filas' => $datos['filas'], ':columnas' => $datos['columnas'],
            ':precio' => $datos['precio'], ':imagen' => $imagen, ':tipo' => $tipo, ':id' => $datos['id']
        ]);
    }

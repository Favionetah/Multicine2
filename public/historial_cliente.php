...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; font-family: 'Montserrat', sans-serif; }
        ...
        .back-btn { background: transparent; color: white; border: 1px solid #555; padding: 8px 20px; border-radius: 20px; text-decoration: none; font-weight: bold; transition: 0.3s; font-size: 0.8rem;}
        ...
        .ticket-card { background: var(--card-bg); border-radius: 15px; border: 1px solid #222; display: flex; overflow: hidden; position: relative;}
        ...
        .t-details { font-size: 0.8rem; color: #aaa; margin-bottom: 15px; display: grid; grid-template-columns: 1fr 1fr; gap: 10px;}
        ...
        .code-box span { font-size: 0.7rem; color: #888; text-transform: uppercase; font-weight: bold; display: block;}
        .code-box strong { font-size: 1.5rem; color: white; letter-spacing: 2px; }
        
        .qr-placeholder { background: white; width: 60px; height: 60px; display: flex; align-items: center; justify-content: center; border-radius: 5px; color: black; font-size: 2rem;}
    </style>
</head>
<body>
                ...
                data.forEach(ticket => {
                    ...
                    container.innerHTML += `
                        <div class="ticket-card">
                            <img src="${ticket.imagenPoster}" class="ticket-poster" onerror="this.src='img/fondo.jpg'">
